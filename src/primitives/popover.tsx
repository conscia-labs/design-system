...
function PopoverContent({ className, children, ...props }: React.ComponentProps<typeof BasePopover.Popup>) { return <PopoverPortal><PopoverPositioner><BasePopover.Popup data-slot="popover-content" className={cn("z-50 w-72 rounded-md border bg-surface-floating p-4 text-text-primary shadow-[var(--ds-shadow-floating)] outline-none data-open:animate-in data-closed:animate-out", className)} {...props}>{children}</BasePopover.Popup></PopoverPositioner></PopoverPortal>; }
