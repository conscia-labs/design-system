  ...
  return (
    <BaseSwitch.Root
      ...
      className={cn(
        ...
        labeled
          ? "relative rounded-[0.625rem] p-0.5 data-[size=default]:h-6 data-[size=default]:w-20 data-[size=default]:[--switch-thumb-travel:3.75rem] data-[size=sm]:h-5 data-[size=sm]:w-[4.5rem] data-[size=sm]:[--switch-thumb-travel:3.5rem] data-checked:bg-action data-unchecked:bg-control-border"
