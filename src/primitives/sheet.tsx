...
function SheetOverlay({ className, ...props }: React.ComponentProps<typeof Drawer.Backdrop>) { return <Drawer.Backdrop data-slot="sheet-overlay" className={cn("fixed inset-0", overlayLayers.modal, "bg-black/50 data-open:animate-in data-closed:animate-out", className)} {...props} />; }
